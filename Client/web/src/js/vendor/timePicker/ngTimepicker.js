    ...
    return {
        ...
        link: function (scope, element, attrs, ngModel) {
            ...
            var initTime = function () {
                ...
                var nameBiding = attrs.ngModel;
                if (nameBiding != null) {
                    var itemSplit = nameBiding.split('.');
                    if (itemSplit.length == 2) {
                        var initString = scope.$parent.ModelData[itemSplit[1]];
                        if (initString != null && initString != "") {
                            time = initString.split(':');
                        }
                    }
		...
		'    <tbody>' +
		'    <tr>' +
		'        <td class="act noselect" ng-click="incrementHour()"><i class="mdi mdi-arrow-up"></i></td>' +
		'        <td></td>' +
		'        <td class="act noselect" ng-click="incrementMinutes()"><i class="mdi mdi-arrow-up"></i></td>' +
		'        <td class="act noselect" ng-click="toggleMeridian()" ng-show="showMeridian"><i class="mdi mdi-arrow-up"></i></td>' +
		'      </tr>' +
		'      <tr>' +
		...
		'      </tr>' +
		'      <tr>' +
		'        <td class="act noselect" ng-click="decreaseHour()"><i class="mdi mdi-arrow-down"></i></td>' +
		'        <td></td>' +
		'        <td class="act noselect" ng-click="decreaseMinutes()"><i class="mdi mdi-arrow-down"></i></td>' +
		'        <td class="act noselect" ng-click="toggleMeridian()" ng-show="showMeridian"><i class="mdi mdi-arrow-down"></i></td>' +
		'      </tr>' +
		'  </table>' +
		'</div>'
    };
